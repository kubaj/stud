...
**/
    ...
    if (L->First == NULL) {
        ...
        L->First->data = val;
        L->First->rptr = prevFirst;
        L->First->lptr = NULL;

        if (prevFirst != NULL) {
            prevFirst->lptr = L->First;
        }
    }
...
**/
    ...
    if (L->Last == NULL) {
        ...
        L->Last->data = val;
        L->Last->lptr = prevLast;
        L->Last->rptr = NULL;

        if (prevLast != NULL) {
            prevLast->rptr = L->Last;
        }
    }
